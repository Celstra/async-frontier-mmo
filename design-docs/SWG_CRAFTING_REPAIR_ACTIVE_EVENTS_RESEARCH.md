...
- Existing project note: `SWG_RESOURCE_CRAFTING_FEEDBACK_RESEARCH.md`
- Existing project note: `DURABILITY_AND_FRAME_MODULE_RESEARCH.md`
...
- Chemical purity matters for sealants, contamination, biological modules, and delicate salvage.

### Allocation / experimentation

After adding resources, the crafter receives a small number of tuning points.

For MVP, use a safer version of SWG experimentation:

```text
3 tuning points at basic crafting
5 tuning points at advanced crafting
7 tuning points at specialist crafting
```
...
- **Risky experiment** — higher upside, meaningful chance of wasted quality or instability.
...
```text
Field Repair Kit
Made from: Veyrith Alloy + Pale Ember Sealant
...
First playable active thumper should have only 3 event prompts:

1. **Signal Drift** — tune/ignore/boost.
2. **Heat Spike** — vent/hold/overdrive.
3. **Hull Damage** — light patch/standard patch/recall.

These cover surveying, risk, and repair without building an entire combat system.
