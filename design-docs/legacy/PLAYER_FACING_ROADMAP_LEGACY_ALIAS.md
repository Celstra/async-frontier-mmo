# Legacy Alias — Player-Facing Roadmap

> Final review note: this file is preserved only for continuity. It is no longer a player-facing promise document and should not be used as an MVP design source. The maintained copy is `../LAYERED_FEATURE_BACKLOG.md`.
