...
|---|---|---|
| Condition Restored | repair amount | MVP: Malleability, OQ, Hardness |
| Integrity Safety | avoids max-condition damage | MVP: Malleability, Hardness, OQ |
| Field Reliability | works during active events / heat / pressure | MVP: Heat Resistance, Conductivity, OQ |
| Compatibility Range | works across module families | Deferred; future may reintroduce Chemical Purity, Malleability, OQ |
...
- Resource hooks: MVP uses Conductivity and OQ; Chemical Purity is a future/deferred hook.
...
- Resource hooks: future/deferred Chemical Purity, plus Malleability and Heat Resistance.
